...
Uploads_Move_Down10               = Pababa 10
Uploads_Tooltip_MoveUp            = Ilipat pataas (mas maagang mag-upload)
Uploads_Tooltip_MoveDown          = Ilipat pababa (mas huling mag-upload)
...
UpdatePrompt_WhatsNew             = Ano ang bago
...
Settings_Upload_MaxParallelParts   = Max. na parallel na bahagi bawat file
Settings_Upload_MaxParallelPartsTip= Nalalapat lamang sa mga hoster na pinapayagan ng protocol na maipadala nang wala sa pagkakasunod-sunod ang mga bahagi ng file. Babaan ito sa metered o hindi matatag na koneksyon.
...
Settings_Upload_DefaultUploadDirectory             = Default na upload directory
Settings_Upload_DefaultUploadDirectory_Watermark   = Buksan kung saan huling nag-browse
Settings_Upload_DefaultUploadDirectoryTip          = Kung saan bubukas ang “Add files…” at “Add folder…”. Iwanang blangko para buksan kung saan ka huling nag-browse.
Settings_Upload_DefaultUploadDirectory_DialogTitle = Piliin ang default na upload directory
```
...
Wizard_Step2_Col_Captcha           = Captcha sa download?
Wizard_Step2_Col_Captcha_Tooltip   = Kung kailangang mag-solve ng captcha ang nagda-download mula sa shared link nang walang account. Hindi kasama ang mga countdown at mga awtomatikong browser check.
Wizard_Step2_Captcha_Unknown       = —
Wizard_Step2_Captcha_UnknownTooltip = Hindi pa nakumpirma kung kailangan ng captcha kapag nagda-download mula sa host na ito.
...
Upload_SkippedNotSignedIn_Format = Nilaktawan — hindi naka-sign in sa {0}. Mag-sign in sa Settings → Accounts, pagkatapos ay simulan muli ang upload.
Accounts_SessionExpired                    = Nag-expire ang session — mag-sign in muli.
Wizard_Step2_SessionExpiredTooltip         = Nag-expire ang sign-in ng account na ito. Buksan ang Settings → Accounts at mag-sign in muli.
Wizard_Hoster_AccountSessionExpired_Format = {0}: nag-expire ang sign-in para sa "{1}", kaya walang ma-a-upload doon — mag-sign in muli sa Settings → Accounts.
Wizard_Step2_CheckAllTip = Piliin o alisin ang lahat ng hoster sa listahan. Sumusunod sa salain at nilalaktawan ang mga nangangailangan ng account.
