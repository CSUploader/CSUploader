...
Uploads_Move_Down10               = Xuống 10
Uploads_Tooltip_MoveUp            = Di chuyển lên (tải lên sớm hơn)
Uploads_Tooltip_MoveDown          = Di chuyển xuống (tải lên muộn hơn)
...
Settings_Upload_MaxParallelParts   = Số phần song song tối đa mỗi tệp
Settings_Upload_MaxParallelPartsTip= Chỉ áp dụng cho các nhà lưu trữ có giao thức cho phép gửi các phần của tệp không theo thứ tự. Hãy giảm giá trị này trên kết nối tính theo dung lượng hoặc không ổn định.
...
Settings_Upload_DefaultUploadDirectory             = Thư mục tải lên mặc định
Settings_Upload_DefaultUploadDirectory_Watermark   = Mở lại nơi đã duyệt lần trước
Settings_Upload_DefaultUploadDirectoryTip          = Nơi “Thêm tệp…” và “Thêm thư mục…” mở ra. Để trống để mở lại nơi bạn đã duyệt lần trước.
Settings_Upload_DefaultUploadDirectory_DialogTitle = Chọn thư mục tải lên mặc định
```
...
Wizard_Step2_Col_Captcha           = CAPTCHA khi tải xuống?
Wizard_Step2_Col_Captcha_Tooltip   = Có cần giải CAPTCHA khi tải xuống từ liên kết chia sẻ mà không đăng nhập tài khoản hay không. Thời gian chờ và các bước kiểm tra trình duyệt diễn ra tự động không được tính.
Wizard_Step2_Captcha_Unknown       = —
Wizard_Step2_Captcha_UnknownTooltip = Chưa xác minh liệu quy trình tải xuống của máy chủ này có yêu cầu CAPTCHA hay không.
...
Upload_SkippedNotSignedIn_Format = Đã bỏ qua — chưa đăng nhập {0}. Hãy đăng nhập trong Cài đặt → Tài khoản rồi bắt đầu tải lên lại.
Accounts_SessionExpired                    = Phiên đăng nhập đã hết hạn — hãy đăng nhập lại.
Wizard_Step2_SessionExpiredTooltip         = Đăng nhập của tài khoản này đã hết hạn. Mở Cài đặt → Tài khoản và đăng nhập lại.
Wizard_Hoster_AccountSessionExpired_Format = {0}: đăng nhập cho "{1}" đã hết hạn nên sẽ không tải lên đó — hãy đăng nhập lại trong Cài đặt → Tài khoản.
Wizard_Step2_CheckAllTip = Chọn hoặc bỏ chọn mọi nhà lưu trữ trong danh sách. Tuân theo bộ lọc và bỏ qua những nhà lưu trữ cần tài khoản.
...
Wizard_AccountCheckFailed_Format   = Không thể đăng nhập vào {0}, nên tài khoản chưa được thêm: {1}    # {0} = hoster name, {1} = verifier message
