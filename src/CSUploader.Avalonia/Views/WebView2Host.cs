// <copyright file="WebView2Host.cs" company="CSUploader">
...
internal sealed class WebView2Host : NativeControlHost
{
    ...
    /// <summary>Raised on the UI thread once the child HWND exists, so the login window can create the
    /// WebView2 controller parented to it.</summary>
