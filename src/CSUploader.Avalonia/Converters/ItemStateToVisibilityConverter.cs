...
/// <summary>
/// Converts a row item (Package or PackageFile) to an <c>IsVisible</c> bool based on its state.
/// ConverterParameter: "Startable", "ForceStartable", or "Stoppable" (default). (Avalonia twin of
/// the WPF converter — same name/state sets; returns bool for IsVisible instead of Visibility.)
/// </summary>
