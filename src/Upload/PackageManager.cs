...
namespace CSUploader.Upload
{
    public class PackageManager
    {
        ...
        public Package AddPackage(PackageOptions options)
        {
        ...
        private void AddPackage(Package package)
        {
            ...
            PackageAdded?.Invoke(this, new PackageAddedEventArgs(null, new PackageDetails[] { package }));
        }
        ...
        private bool StartPackage(PackageJob job)
        {
            ...
            else if (job == PackageJob.Upload)
            {
                ...
                maxConcurrentJobs = Settings.MaxConcurrentUploadJobs;
            }
