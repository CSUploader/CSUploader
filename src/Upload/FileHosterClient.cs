...
namespace CSUploader.Upload
{
    ...
    public abstract class FileHosterClient
    {
        ...
        /// </summary>
        public event EventHandler<FileHosterHashingFinshedEventArgs>? HashingFinished;
        ...
        /// </summary>
        /// <param name="sender">The sender.</param>
        /// <param name="e">The <see cref="FileHosterHashingFinshedEventArgs"/> instance containing the event data.</param>
        protected virtual void FireHashingFinished(object sender, FileHosterHashingFinshedEventArgs e)
        {
        ...
        {
            FireHashingFinished(this, new FileHosterHashingFinshedEventArgs(e));
        }
    }
}
