...
public static class HosterCredentialModes
{
    ...
    private static readonly HashSet<string> ApiKeyHosters =
        [with(StringComparer.OrdinalIgnoreCase), "Buzzheavier", "Ex-Load", "KatFile", "Hexload", "Hxfile", "FileBoom", "HitFile", "Turbobit", "Keep2Share", "TezFiles", "NitroFlare", "Ufile", "Send.now", "Uploadrar", "FILEAXA"];
